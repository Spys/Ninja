...
client.on("message", async function(message) {
 ...
 client.on("message", async function(message) {
    ...
    .setColor("#010101")
    .setTitle("Voici quelque Infomation sur votre Serveur")
    .setDescription("Toutes les Informations de Serveur se retrouverons ici")
    .addField(":spy:|Nombre de Membre", message.guild.members.size)
    .addField(":spy:|Categorie,Salon", message.guild.channel.size)
    .setFooter("Ninjay |by Nefer")
